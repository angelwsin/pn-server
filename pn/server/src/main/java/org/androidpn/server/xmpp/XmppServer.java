...
public class XmppServer {
    ...
    public void start() {
        try {
            ...
            serverName = Config.getString("xmpp.domain", "127.0.0.1")
                    .toLowerCase();
            context = new ClassPathXmlApplicationContext("server-config.xml");
    ...
    private void locateServer() throws FileNotFoundException {
        ...
        if (serverHomeDir == null) {
            try {
                ...
                log.debug("base.dir=" + confDir.getCanonicalPath());
                if (confDir.exists()) {
    ...
    public static void main(String[] args) throws Exception{
       // System.setProperty("base.dir", "C:\\Users\\wb-wq209038\\Desktop\\ex\\ex");
        String baseDir = System.getProperty("base.dir", "..");
        File confDir = new File(baseDir, "conf");
        System.out.println(confDir.exists());
        System.out.println(confDir.getCanonicalPath());
    }
